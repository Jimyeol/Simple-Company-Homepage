...
<body>
    <!-- membership.jsp에서 입력한 정보를 넘겨 받아 처리한다. -->
    <% 
    ...
    <div id="wrap">
        <br><br>
        <b><font size="5" color="green">회원가입 정보를 확인하세요.</font></b>
        <br><br>
        <font color="green"><%=name %></font>님 가입을 축하드립니다.
        <br><br>
	...
	<label for="submit"><input type="submit" value="회원가입 완료"></label>
</div>
</ul>
</form>
    </div>
